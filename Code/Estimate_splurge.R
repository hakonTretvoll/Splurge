...
splurge_parameter_estimation <- function(c_vector, Omega, T, init_params=NULL, fixed_index=NULL,moments_for_estimation=NULL){
  ...
  phi         <- output_params[3] 
  psi         <- output_params[4]
  psi_tilde   <- output_params[5]
  omega       <- output_params[6]
  theta       <- output_params[7]
  var_c_error <- output_params[8] 
  varcsi    <- output_params[9] 
  ...
  phi_se         <- output_se[3] 
  psi_se         <- output_se[4]
  psi_tilde_se   <- output_se[5]
  omega_se       <- output_se[6]
  theta_se       <- output_se[7]
  var_c_error_se <- output_se[8] 
  varcsi_se      <- output_se[9] 
